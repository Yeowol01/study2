...
void CreateMaze()
{
	...
	strcpy(maze[2], "1001111011");
	strcpy(maze[3], "1100111001");
	strcpy(maze[4], "1110011101");
	strcpy(maze[5], "1100111001");
	strcpy(maze[6], "1000011011");
	strcpy(maze[7], "1001011001");
	strcpy(maze[8], "1011001101");
	strcpy(maze[9], "1111111121");
}
